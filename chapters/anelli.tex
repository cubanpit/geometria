...
La struttura di gruppo si compone sempre di un insieme e di un'operazione, perciò si identifica convenzionalmente con la coppia $(G,*)$; un insieme può formare gruppi differenti in base all'operazione associata.
...
\begin{proof}
	...
	Poniamo ora le due classi coincidenti, siccome $a\in[a]$ e $a'\in[a']$ e le due classi coincidono si ha che $a$ appartiene anche ad $[a']$ e $a'$ appartiene anche ad $[a]$, quindi $a\sim a'$.
\end{proof}
...
L'esistenza dell'elemento neutro della moltiplicazione, invece, non è data per certa: se esiste, l'anello si dice \emph{dotato di unità}, e lo indicheremo con $1$ o $1_A$.
